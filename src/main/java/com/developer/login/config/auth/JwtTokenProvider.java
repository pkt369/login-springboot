...
import com.developer.login.user.dto.OAuth2UserImpl;
...
public class JwtTokenProvider implements AuthenticationSuccessHandler {
    ...
    public String createToken(com.developer.login.user.domain.User user) {
        return Jwts.builder()
    ...
    public ResponseCookie getJwtCookie(com.developer.login.user.domain.User user) {
